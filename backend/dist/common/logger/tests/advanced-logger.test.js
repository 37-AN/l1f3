...
const advanced_logger_service_1 = require("../advanced-logger.service");
describe('AdvancedLoggerService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get(advanced_logger_service_1.AdvancedLoggerService);
...
//# sourceMappingURL=advanced-logger.test.js.map