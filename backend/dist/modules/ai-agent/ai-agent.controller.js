...
let AIAgentController = AIAgentController_1 = class AIAgentController {
    ...
    async analyzeGoalProgress(goalId) {
        try {
            this.logger.log(`Analyzing goal progress${goalId ? ` for goal ${goalId}` : ""}...`);
    ...
    async logRevenue(logRevenueDto) {
        try {
            ...
            const success = await this.aiAgentService.logBusinessRevenue(logRevenueDto.amount, logRevenueDto.description || "43V3R Revenue");
            return {
                success,
    ...
    async updateNetWorth(updateNetWorthDto) {
        try {
            ...
            const result = await this.aiAgentService.updateNetWorth(updateNetWorthDto.newAmount);
            return {
                ...result,
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Generate daily LIF3 command center briefing" }),
...
], AIAgentController.prototype, "getDailyBriefing", null);
__decorate([
    (0, common_1.Get)("analysis/goal-progress"),
    (0, swagger_1.ApiOperation)({ summary: "Analyze progress toward financial goals" }),
    ...
    __metadata("design:returntype", Promise)
], AIAgentController.prototype, "analyzeGoalProgress", null);
__decorate([
    (0, common_1.Get)("strategy/business"),
    (0, swagger_1.ApiOperation)({ summary: "Generate 43V3R business strategy insights" }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AIAgentController.prototype, "getBusinessStrategy", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AIAgentController.prototype, "logRevenue", null);
__decorate([
    (0, common_1.Post)("networth/update"),
    (0, swagger_1.ApiOperation)({ summary: "Update net worth and get analysis" }),
    (0, swagger_1.ApiBody)({ type: UpdateNetWorthDto }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [UpdateNetWorthDto]),
    __metadata("design:returntype", Promise)
], AIAgentController.prototype, "updateNetWorth", null);
__decorate([
    (0, common_1.Get)("context/financial"),
    (0, swagger_1.ApiOperation)({ summary: "Get current financial context for AI analysis" }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AIAgentController.prototype, "getFinancialContext", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AIAgentController.prototype, "getAgentStatus", null);
